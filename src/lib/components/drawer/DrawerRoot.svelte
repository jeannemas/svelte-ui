<script context="module" lang="ts">
  ...
  type Primitive = ComponentInfo<DrawerPrimitive.Root>;
   ...
   */
  export type Props = Omit<Primitive['props'], 'backgroundColor' | 'preventScroll'>;
  /**
...
<script lang="ts">
  ...
  export let nested: Props['nested'] = undefined;
